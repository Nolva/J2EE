...
public class CustomerService {
    ...
    //分页管理
    public List<Customer> ListManagerByPage(int startRow){
        return customerDAO.ListManagerByPage(startRow*PAGE_SIZE, PAGE_SIZE);
    }
    ...
    public int getTotalPage(){
        int total = customerDAO.getCustomerNum();
