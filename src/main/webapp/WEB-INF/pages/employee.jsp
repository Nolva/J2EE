                    ...
                    <div class="container-fluid">
                        <form class="form-horizontal" action="/employee/add" method="post">
                            ...
                            <div class="form-group " >
                                <label class="col-xs-3 control-label">员工部门：</label>
                                <div class="col-xs-6 ">
                                    <select class="form-control input-sm duiqi selectpicker" name="empDepartment" id="empDepartment2" onchange="selectJob_add()">
                                        <c:forEach items="${departmentList}" var="empDepartment">
                                            <%-- <option value="主管部门"  checked="checked">主管部门</option>
                                             <option value="销售部门" >销售部门</option>
                                             <option value="产品部门" >产品部门</option>
...
<script>
    ...
    function selectJob_add() {
        //alert("aaa");
        //部门
        var department = $("#empDepartment2").val();
        //console.log(department);
        $.ajax({
            type: "post" ,
            url: "/employee/queryJob.shtml"+"?"+department,
