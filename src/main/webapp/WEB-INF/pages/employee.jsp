                        ...
                        <form class="form-horizontal" action="/employee/change" method="post">
                            ...
                            <div class="form-group " >
                                <div class="form-group " >
                                    ...
                                    <div class="col-xs-6 ">
                                        <div id = "empSex" class="form-control input-sm duiqi">
                                ...
                                <div class="form-group " >
                                    ...
                                    <div id = "empEducation" class="col-xs-6 ">
                                        <select class="form-control input-sm duiqi selectpicker" name="empEducation">
                                            <option value="主管人员" >博士</option>
                                            <option value="销售人员" >硕士研究生</option>
                                            <option value="产品人员" >本科</option>
                                            <option value="监管人员" >专科</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="container-fluid">
                        <form class="form-horizontal" action="/employee/add" method="post">
                            ...
                            <div class="form-group " >
                                <label class="col-xs-3 control-label ">员工性别:</label>
                                <div class="col-xs-6 ">
                                    <div id="empSex3" class="form-control input-sm duiqi" >
...
<script>
    ...
    $('#changeChar').on('show.bs.modal',function(event){
        ...
        var picker3 = $('#empHireDate').datetimepicker({
            maxView:4,
            minView:2,
            endDate:new Date(),
            todayHighlight:1,
        ...
        var picker4 = $('#empBirthday').datetimepicker({
            maxView:4,
            minView:2,
            endDate:new Date(),
            todayHighlight:1,
    ...
    $('#addChar').on('show.bs.modal',function(event){
        ...
        var picker1 = $('#empHireDate3').datetimepicker({
            maxView:4,
            minView:2,
            endDate:new Date(),
            todayHighlight:1,
        ...
        var picker2 = $('#empBirthday3').datetimepicker({
            maxView:4,
            minView:2,
            endDate:new Date(),
            todayHighlight:1,
